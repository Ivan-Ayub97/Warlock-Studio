  ...
  <tr>
    <td align="center">
      <a href="https://sourceforge.net/projects/warlock-studio/files/latest/download">
        <img src="https://a.fsdn.com/con/app/sf-download-button" alt="Download from SourceForge" <!-- Begin  Tag -->
<div class="sf-root" data-id="3880091" data-badge="oss-users-love-us-white" style="width:125px">
    <a href="https://sourceforge.net/projects/warlock-studio/" target="_blank">Warlock-Studio</a>
</div>
<script>(function () {var sc=document.createElement('script');sc.async=true;sc.src='https://b.sf-syn.com/badge_js?sf_id=3880091';var p=document.getElementsByTagName('script')[0];p.parentNode.insertBefore(sc, p);})();
</script>
<!-- End  Tag --> />
      </a>
    </td>
